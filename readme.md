...
> [!IMPORTANT]: Esta es sólo una versión de prueba. La versión actualizada el frontend consume el backend mediante api y utiliza podman. Está en un repositorio privado.
