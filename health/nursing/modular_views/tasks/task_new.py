...
def modular_new_task(request):
    ...
    before = (
        ...
        + "; task.done_time: "
        + str(task.done_time)
        + "; task.active: False; task.state: No State; task.programed_by: "
        + task.programed_by
        + " ; task.task_done_by: "
        + task.task_done_by
        + " ; task.action_done_by: "
    ...
    save_event(username, "new task", before, after)
