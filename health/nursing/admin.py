...
class UserAdmin(admin.ModelAdmin):
    list_display = ('username', 'email', 'date_joined', 'is_active', 'is_staff', 'is_superuser', 'is_leader', 'role')
    ordering = ('username',)
    search_fields = ('username', 'email', 'role')
    list_filter = ('is_staff', 'is_active', 'is_superuser', 'is_leader', 'date_joined', 'role')

class PatientAdmin(admin.ModelAdmin):
    list_display = ('name', 'id_card_number', 'social_security_number', 'inpatient', 'admission', 'diagnosis', 'short_diagnosis', 'treatment_roadmap', 'action_done_by')
    ordering = ('name',)
    search_fields = ('name', 'id_card_number', 'social_security_number', 'inpatient', 'diagnosis', 'short_diagnosis', 'treatment_roadmap', 'action_done_by')
    list_filter = ('name', 'id_card_number', 'social_security_number', 'admission', 'inpatient', 'diagnosis', 'short_diagnosis', 'treatment_roadmap', 'action_done_by',)
...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('bed', 'programed_time', 'done_time', 'task', 'repeat', 'repeat_id', 'active', 'state', 'programed_by', 'task_done_by', 'action_done_by')
    ordering = ('-programed_time',)
    search_fields = ('bed', 'programed_time', 'done_time', 'task', 'repeat', 'repeat_id', 'active', 'state', 'programed_by', 'task_done_by', 'action_done_by')
    list_filter = ('bed', 'programed_time', 'done_time', 'task', 'repeat', 'repeat_id', 'active', 'state', 'programed_by', 'task_done_by', 'action_done_by',)
